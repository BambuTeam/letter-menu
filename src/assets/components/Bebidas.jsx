...
const Bebidas = () => {
        ...
        <div className="content_desayunos" id="Click_bebidas">
            ...
            <Container fluid className="Container_desayuno">
                <Row >
                    ...
                    <div>
                    <h3>Preparados con nuestro café de la Finca.</h3>
                    </div>
                </Row>
    ...
    <Container>
                ...
                <Row>
                <Col xs={10} md={12} lg={10} className="Style_Desayuno_List" >
                <h2>Jhonnie Walker Blue Labbel</h2>
                </Col>
                <Col xs={2} md={12} lg={2} className="Style_Desayuno_List F_rigth" >
                <h2>Q.250</h2>
                </Col>
                ...
                <Row>
                <Col xs={10} md={12} lg={10} className="Style_Desayuno_List" >
                <h2>Jhonnie Walker Gold Label</h2>
                </Col>
                <Col xs={2} md={12} lg={2} className="Style_Desayuno_List F_rigth" >
                <h2>Q.95</h2>
                </Col>
                ...
                <Row>
                <Col xs={10} md={12} lg={10} className="Style_Desayuno_List" >
                <h2>Jhonnie Walker Black Label</h2>
                </Col>
                <Col xs={2} md={12} lg={2} className="Style_Desayuno_List F_rigth" >
                <h2>Q.60</h2>
                </Col>
                ...
                <Row>
                <Col xs={10} md={12} lg={10} className="Style_Desayuno_List" >
                <h2>Jhonnie Walker Red Label</h2>
                </Col>
                <Col xs={2} md={12} lg={2} className="Style_Desayuno_List F_rigth" >
                <h2>Q.45</h2>
                </Col>
               ...
               <Container>
                ...
                <Row>
                <Col xs={10} md={12} lg={10} className="Style_Desayuno_List" >
                <h2>Selección Antigua Cerveza</h2> <h2>(Sin novia, muy noble)</h2>
                </Col>
                <Col xs={2} md={12} lg={2} className="Style_Desayuno_List F_rigth" >
                <h2>Q.42</h2>
                </Col>
                ...
                <Row>
                <Col xs={10} md={12} lg={10} className="Style_Desayuno_List" >
                <h2>Selección San Roque</h2> <h2>(PIPA, Lager)  </h2>
                </Col>
                <Col xs={2} md={12} lg={2} className="Style_Desayuno_List F_rigth" >
                <h2>Q.40</h2>
                </Col>
                ...
                <Row>
                <Col xs={10} md={12} lg={10} className="Style_Desayuno_List" >
                <h2>Selección El Zapote</h2> <h2>(IPA, Belgian White, American Lager, Hefe Weizen 
                 Scottish Ale, Porter)
                </h2>
                </Col>
                <Col xs={2} md={12} lg={2} className="Style_Desayuno_List F_rigth" >
                ...
                <Row>
                <Col xs={10} md={12} lg={10} className="Style_Desayuno_List" >
                <h2>Jugo de tomate preparado</h2>
                </Col>
                <Col xs={2} md={12} lg={2} className="Style_Desayuno_List F_rigth" >
                <h2>Q.30</h2>
                </Col>
